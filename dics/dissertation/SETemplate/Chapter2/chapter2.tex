...
\end{algorithmic}
An algorithm which has been previously overlooked as it was initially assumed to be fairly simple is the file writer. After further research which resulted in the memory check algorithm it has been decided that its process should be noted due to the various ways it could be completed. Initial design should be as follows. 
\section{Interfaces}
